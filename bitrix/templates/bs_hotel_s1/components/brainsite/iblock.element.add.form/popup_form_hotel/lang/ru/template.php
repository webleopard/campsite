...
$MESS["FORM_HEADER"] = "Оставить заявку";
$MESS["FORM_COMMENT"] = "Отправьте заявку и мы проконсультируем Вас по всем вопросам!";

/*Модуль Бронирование*/
$MESS["MODUL_FREE_COUNT"]="Номеров доступно";
$MESS["MODUL_FREE_COUNT_FROM"]="из";
$MESS["MODUL_ITEM_DAYS_NAME"]="Дней";
$MESS["MODUL_DISABLED_ORDER_BY_FREE"]="Нет доступных номеров";
