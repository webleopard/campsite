	...
	<form action="" method="get">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody><tr>
				...
				<td>
					<div class="btn_container ripple"><input class="search-button btn" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" /></div>
				</td>
			</tr>
		</tbody></table>
				...
				<div id="search_params" class="search-filter" style="display:<?echo $arResult["REQUEST"]["FROM"] || $arResult["REQUEST"]["TO"] || $arResult["REQUEST"]["WHERE"]? 'block': 'none'?>">
					...
					<table class="search-filter" cellspacing="0"><tbody>
						...
						<tr>
							...
							<td class="search-filter-field"><div class="btn_container ripple"><input class="search-button btn" value="<?echo GetMessage("CT_BSP_GO")?>" type="submit"></div></td>
						</tr>
					</tbody></table>
				</div>
			<?else:?>
