...
<?if($arResult["NavPageCount"] > 1):?>
    <?if ($arResult["NavPageNomer"]+1 <= $arResult["nEndPage"]):?>
        <?
            ...
            $url = str_replace(' ','%20',$arResult["sUrlPathParams"]) . "PAGEN_".$arResult["NavNum"]."=".$plus; 
        ?>
        <div class="text-center">
        	<a class="load_more" style="cursor:pointer;width:100%" data-url="<?=$url?>">
...
<div class="modern-page-navigation paging  more_places">
<?
