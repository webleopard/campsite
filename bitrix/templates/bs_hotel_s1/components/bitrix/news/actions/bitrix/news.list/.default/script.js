$(function() {
	...
	$(".slider_actions.owl-carousel").owlCarousel({
		pagination: true,
		//autoplay: true,
		nav: ($(".slider_actions .item").length > 3) ? true: false,
		loop: ($(".slider_actions .item").length > 3) ? true: false,
		dots: ($(".slider_actions .item").length > 3) ? true: false,
