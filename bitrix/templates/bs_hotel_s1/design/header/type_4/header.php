	...
	<div class="content_container">
		<div class="header_content d-flex justify-content-between">
			...
			<div class="flex-grow-1 justify-content-center d-none d-xl-flex">
				...
				<div class="slogan_search flex-grow-1 align-self-center text-center d-block">
					<div class="slogan flex-grow-1 align-self-center d-block"><?$APPLICATION->IncludeFile(SITE_DIR."include/slogan.php");?></div>
