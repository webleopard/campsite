<footer class="footer_type_<?=$footer_type?> <?=strtolower($GLOBALS["OPTION_FOOTER_FONT_COLOR"])?> <?=$footer_css_filter_logo ? "footer_css_filter_logo":""?>">	
	<div class="footer_container h100p">
	<div class="d-flex flex-column h100p">
				...
				<div class="top_block row mr-0 ml-0 flex-grow-1">
						...
						<div class="col-12 col-lg-10">
							<div class="row mr-0 ml-0">
								...
								<div class="col-4 d-none d-sm-block contacts">
									<div class="label"><b>Контакты:</b></div>
								...
								<div class="col-12 col-sm-4  text-center text-sm-left">
									<div>
										...
										if (CModule::IncludeModule('subscribe')) {
											$APPLICATION->IncludeComponent("bitrix:sender.subscribe", "subscribe", Array("SET_TITLE" => "N"), false);
											?><div class="air p10"></div><?
										}
										?>
										...
										<div class="schedule iconfont_container">
											<?$APPLICATION->IncludeFile(SITE_DIR."include/schedule.php");?>
										</div>
										<?} ?>
										<div class="air p20"></div>
										<div class="callback"><a class="fancybox btn ripple <?=CModule::IncludeModule('subscribe') ? "small":"" ?>" data-comment="Заказ звонка" href="#popup_callback"><?=GetMessage("CALLBACK_BTN_TEXT") ?></a></div>
				...
				<div class="bottom_block">
					<div class="footer_bottom_block row mr-0 ml-0">
						<div class="col-12 col-sm-6 text-center text-sm-left"><?$APPLICATION->IncludeFile(SITE_DIR."include/copyright.php");?></div>
						<div class="col-6 text-right d-none d-sm-block"><?$APPLICATION->IncludeComponent(
									"bitrix:main.include",
									"",
									Array(
										"AREA_FILE_SHOW" => "file",
