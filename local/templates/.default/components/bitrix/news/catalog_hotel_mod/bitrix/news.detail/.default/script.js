$(function() {
	...
	$(".catalog_item .slider_images.owl-carousel").owlCarousel({
		pagination: true,
		//autoplay: true,
		nav: ($(".catalog_item .slider_images .item_img").length > 3) ? true: false,
		loop: false,
		items: 1,
		dots: ($(".catalog_item .slider_images .item_img").length > 3) ? true: false,
	...
	$(document).on('click', '.catalog_item .order_container .btn', function() 
	{
